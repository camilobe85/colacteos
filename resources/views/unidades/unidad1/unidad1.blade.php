...
<div class="row affix-row">
  ...
  <div class="navbar navbar-default col-sm-3 col-md-2 affix-sidebar" role="navigation">
    <div class="navbar-header">
      ...
      <span class="visible-xs navbar-brand">Ver contenido de unidad</span>
    </div>
    <div class="navbar-collapse collapse sidebar-navbar-collapse">
      <ul class="nav navbar-nav" id="sidenav01">
        <li class="active">
          ...
          Unidad 1
          <br>
          <small>HISTORIA DEL COOPERATIVISMO <span class="caret"></span></small>
          </h4>
          </a>
          <div class="collapse" id="toggleDemo0" style="height: 0px;">
            <ul class="nav nav-list">
              <li><a href="#">Volver a unidades</a></li>
            </ul>
          </div>
        </li>
        <li>
          <a href="#" data-toggle="collapse" data-target="#toggleDemo" data-parent="#sidenav01" class="collapsed">
          <span class="glyphicon glyphicon-cloud"></span> 1.1.	Primera parte:  La cooperación y la solidaridad como un hecho recurrente en la historia<span class="caret pull-right"></span>
          </a>
        ...
        <li >
          ...
          <span class="glyphicon glyphicon-inbox"></span> 1.2.	Segunda parte: Precursores de las ideas cooperativas y la economía solidaria <span class="caret pull-right"></span>
          </a>
	...
	<h3><span class="glyphicon glyphicon-th-list"></span> Unidad 1</h3>
</div>
